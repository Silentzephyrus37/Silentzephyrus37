...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-02-27 08:51 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2025-68499`**](https://nvd.nist.gov/vuln/detail/CVE-2025-68499) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.5**<br><sub>Improper Neutralization of Input During Web Page Generation ('Cross-site Scripting') vulnerab...</sub><br><sub>Published: `2025-12-30`</sub> | [**Odido**](https://www.google.com/search?q=Odido%20data%20breach&tbm=nws) &nbsp; <sub>`odido.nl`</sub><br><sub>**688,102** accounts compromised</sub><br><sub>Data: `bank account numbers` `customer service comments` `dates of birth` &nbsp;·&nbsp; Added: `2026-02-26`</sub> |
| [**`CVE-2025-68498`**](https://nvd.nist.gov/vuln/detail/CVE-2025-68498) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.5**<br><sub>Missing Authorization vulnerability in Crocoblock JetTabs allows Exploiting Incorrectly Confi...</sub><br><sub>Published: `2025-12-30`</sub> | [**CanadianTire**](https://www.google.com/search?q=CanadianTire%20data%20breach&tbm=nws) &nbsp; <sub>`canadiantire.ca`</sub><br><sub>**38,306,562** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-02-25`</sub> |
| [**`CVE-2025-68120`**](https://nvd.nist.gov/vuln/detail/CVE-2025-68120) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.4**<br><sub>To prevent unexpected untrusted code execution, the Visual Studio Code Go extension is now di...</sub><br><sub>Published: `2025-12-30`</sub> | [**CarGurus**](https://www.google.com/search?q=CarGurus%20data%20breach&tbm=nws) &nbsp; <sub>`cargurus.com`</sub><br><sub>**12,461,887** accounts compromised</sub><br><sub>Data: `email addresses` `ip addresses` `names` &nbsp;·&nbsp; Added: `2026-02-22`</sub> |
<!-- SECURITY-END -->
---
