...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-04-25 09:01 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-27588`**](https://nvd.nist.gov/vuln/detail/CVE-2026-27588) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.1**<br><sub>Caddy is an extensible server platform that uses TLS by default. Prior to version 2.11.1, Cad...</sub><br><sub>Published: `2026-02-24`</sub> | [**Carnival**](https://www.google.com/search?q=Carnival%20data%20breach&tbm=nws) &nbsp; <sub>`carnivalcorp.com`</sub><br><sub>**7,531,359** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-04-24`</sub> |
| [**`CVE-2026-27587`**](https://nvd.nist.gov/vuln/detail/CVE-2026-27587) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.1**<br><sub>Caddy is an extensible server platform that uses TLS by default. Prior to version 2.11.1, Cad...</sub><br><sub>Published: `2026-02-24`</sub> | [**Amtrak**](https://www.google.com/search?q=Amtrak%20data%20breach&tbm=nws) &nbsp; <sub>`amtrak.com`</sub><br><sub>**2,147,679** accounts compromised</sub><br><sub>Data: `email addresses` `names` `physical addresses` &nbsp;·&nbsp; Added: `2026-04-17`</sub> |
| [**`CVE-2026-27586`**](https://nvd.nist.gov/vuln/detail/CVE-2026-27586) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.1**<br><sub>Caddy is an extensible server platform that uses TLS by default. Prior to version 2.11.1, two...</sub><br><sub>Published: `2026-02-24`</sub> | [**McGrawHill**](https://www.google.com/search?q=McGrawHill%20data%20breach&tbm=nws) &nbsp; <sub>`mheducation.com`</sub><br><sub>**13,500,136** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-04-16`</sub> |
<!-- SECURITY-END -->
---
