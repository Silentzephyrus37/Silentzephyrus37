...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-02 08:54 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2025-69284`**](https://nvd.nist.gov/vuln/detail/CVE-2025-69284) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.3**<br><sub>Plane is an an open-source project management tool. In plane.io, a guest user doesn't have a ...</sub><br><sub>Published: `2026-01-02`</sub> | [**Lovora**](https://www.google.com/search?q=Lovora%20data%20breach&tbm=nws) &nbsp; <sub>``</sub><br><sub>**495,556** accounts compromised</sub><br><sub>Data: `display names` `email addresses` `profile photos` &nbsp;·&nbsp; Added: `2026-03-02`</sub> |
| [**`CVE-2025-67269`**](https://nvd.nist.gov/vuln/detail/CVE-2025-67269) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>An integer underflow vulnerability exists in the `nextstate()` function in `gpsd/packet.c` of...</sub><br><sub>Published: `2026-01-02`</sub> | [**Quitbro**](https://www.google.com/search?q=Quitbro%20data%20breach&tbm=nws) &nbsp; <sub>`quitbro.app`</sub><br><sub>**22,874** accounts compromised</sub><br><sub>Data: `email addresses` `partial dates of birth` `usernames` &nbsp;·&nbsp; Added: `2026-03-02`</sub> |
| [**`CVE-2025-67268`**](https://nvd.nist.gov/vuln/detail/CVE-2025-67268) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>gpsd before commit dc966aa contains a heap-based out-of-bounds write vulnerability in the dri...</sub><br><sub>Published: `2026-01-02`</sub> | [**KomikoAI**](https://www.google.com/search?q=KomikoAI%20data%20breach&tbm=nws) &nbsp; <sub>`komiko.app`</sub><br><sub>**1,060,191** accounts compromised</sub><br><sub>Data: `ai prompts` `email addresses` `forum posts` &nbsp;·&nbsp; Added: `2026-03-02`</sub> |
<!-- SECURITY-END -->
---
