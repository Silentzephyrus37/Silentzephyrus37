...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-22 08:42 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-23524`**](https://nvd.nist.gov/vuln/detail/CVE-2026-23524) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>Laravel Reverb provides a real-time WebSocket communication backend for Laravel applications....</sub><br><sub>Published: `2026-01-21`</sub> | [**Aura**](https://www.google.com/search?q=Aura%20data%20breach&tbm=nws) &nbsp; <sub>`aura.com`</sub><br><sub>**903,080** accounts compromised</sub><br><sub>Data: `customer service comments` `email addresses` `ip addresses` &nbsp;·&nbsp; Added: `2026-03-18`</sub> |
| [**`CVE-2026-23518`**](https://nvd.nist.gov/vuln/detail/CVE-2026-23518) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>Fleet is open source device management software. In versions prior to 4.78.3, 4.77.1, 4.76.2,...</sub><br><sub>Published: `2026-01-21`</sub> | [**DivineSkins**](https://www.google.com/search?q=DivineSkins%20data%20breach&tbm=nws) &nbsp; <sub>`divineskins.gg`</sub><br><sub>**105,814** accounts compromised</sub><br><sub>Data: `email addresses` `purchases` `usernames` &nbsp;·&nbsp; Added: `2026-03-15`</sub> |
| [**`CVE-2026-23517`**](https://nvd.nist.gov/vuln/detail/CVE-2026-23517) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.1**<br><sub>Fleet is open source device management software. A broken access control issue in versions pr...</sub><br><sub>Published: `2026-01-21`</sub> | [**Baydoner**](https://www.google.com/search?q=Baydoner%20data%20breach&tbm=nws) &nbsp; <sub>`baydoner.com`</sub><br><sub>**1,266,822** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-03-15`</sub> |
<!-- SECURITY-END -->
---
