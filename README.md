...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-11 08:52 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-22798`**](https://nvd.nist.gov/vuln/detail/CVE-2026-22798) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.9**<br><sub>hermes is an implementation of the HERMES workflow to automatize software publication with ri...</sub><br><sub>Published: `2026-01-12`</sub> | [**Provecho**](https://www.google.com/search?q=Provecho%20data%20breach&tbm=nws) &nbsp; <sub>`provecho.bio`</sub><br><sub>**712,904** accounts compromised</sub><br><sub>Data: `email addresses` `usernames` &nbsp;·&nbsp; Added: `2026-03-03`</sub> |
| [**`CVE-2026-22794`**](https://nvd.nist.gov/vuln/detail/CVE-2026-22794) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.6**<br><sub>Appsmith is a platform to build admin panels, internal tools, and dashboards. Prior to 1.93, ...</sub><br><sub>Published: `2026-01-12`</sub> | [**Lovora**](https://www.google.com/search?q=Lovora%20data%20breach&tbm=nws) &nbsp; <sub>``</sub><br><sub>**495,556** accounts compromised</sub><br><sub>Data: `display names` `email addresses` `profile photos` &nbsp;·&nbsp; Added: `2026-03-02`</sub> |
| [**`CVE-2026-22789`**](https://nvd.nist.gov/vuln/detail/CVE-2026-22789) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.4**<br><sub>WebErpMesv2 is a Resource Management and Manufacturing execution system Web for industry. Pri...</sub><br><sub>Published: `2026-01-12`</sub> | [**Quitbro**](https://www.google.com/search?q=Quitbro%20data%20breach&tbm=nws) &nbsp; <sub>`quitbro.app`</sub><br><sub>**22,874** accounts compromised</sub><br><sub>Data: `email addresses` `partial dates of birth` `usernames` &nbsp;·&nbsp; Added: `2026-03-02`</sub> |
<!-- SECURITY-END -->
---
