...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-04-19 09:00 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-2507`**](https://nvd.nist.gov/vuln/detail/CVE-2026-2507) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>When BIG-IP AFM or BIG-IP DDoS is provisioned, undisclosed traffic can cause TMM to terminate...</sub><br><sub>Published: `2026-02-18`</sub> | [**Amtrak**](https://www.google.com/search?q=Amtrak%20data%20breach&tbm=nws) &nbsp; <sub>`amtrak.com`</sub><br><sub>**2,147,679** accounts compromised</sub><br><sub>Data: `email addresses` `names` `physical addresses` &nbsp;·&nbsp; Added: `2026-04-17`</sub> |
| [**`CVE-2026-2230`**](https://nvd.nist.gov/vuln/detail/CVE-2026-2230) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.3**<br><sub>The Booking Calendar plugin for WordPress is vulnerable to Insecure Direct Object Reference i...</sub><br><sub>Published: `2026-02-18`</sub> | [**McGrawHill**](https://www.google.com/search?q=McGrawHill%20data%20breach&tbm=nws) &nbsp; <sub>`mheducation.com`</sub><br><sub>**13,500,136** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-04-16`</sub> |
| [**`CVE-2025-70149`**](https://nvd.nist.gov/vuln/detail/CVE-2025-70149) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>CodeAstro Membership Management System 1.0 is vulnerable to SQL Injection in print_membership...</sub><br><sub>Published: `2026-02-18`</sub> | [**Hallmark**](https://www.google.com/search?q=Hallmark%20data%20breach&tbm=nws) &nbsp; <sub>`hallmark.com`</sub><br><sub>**1,736,520** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-04-12`</sub> |
<!-- SECURITY-END -->
---
