...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-05-12 10:37 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-32329`**](https://nvd.nist.gov/vuln/detail/CVE-2026-32329) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.3**<br><sub>Missing Authorization vulnerability in Ays Pro Advanced Related Posts advanced-related-posts ...</sub><br><sub>Published: `2026-03-13`</sub> | [**CushmanWakefield**](https://www.google.com/search?q=CushmanWakefield%20data%20breach&tbm=nws) &nbsp; <sub>`cushmanwakefield.com`</sub><br><sub>**310,431** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-05-12`</sub> |
| [**`CVE-2026-32328`**](https://nvd.nist.gov/vuln/detail/CVE-2026-32328) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.4**<br><sub>Cross-Site Request Forgery (CSRF) vulnerability in shufflehound Lemmony lemmony allows Cross ...</sub><br><sub>Published: `2026-03-13`</sub> | [**Zara**](https://www.google.com/search?q=Zara%20data%20breach&tbm=nws) &nbsp; <sub>`zara.com`</sub><br><sub>**197,376** accounts compromised</sub><br><sub>Data: `email addresses` `geographic locations` `purchases` &nbsp;·&nbsp; Added: `2026-05-08`</sub> |
| [**`CVE-2026-32322`**](https://nvd.nist.gov/vuln/detail/CVE-2026-32322) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.3**<br><sub>soroban-sdk is a Rust SDK for Soroban contracts. Prior to 22.0.11, 23.5.3, and 25.3.0, The Fr...</sub><br><sub>Published: `2026-03-13`</sub> | [**Woflow**](https://www.google.com/search?q=Woflow%20data%20breach&tbm=nws) &nbsp; <sub>`woflow.com`</sub><br><sub>**447,593** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-05-07`</sub> |
<!-- SECURITY-END -->
---
