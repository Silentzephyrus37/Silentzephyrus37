...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-31 09:08 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2020-37043`**](https://nvd.nist.gov/vuln/detail/CVE-2020-37043) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>10-Strike Bandwidth Monitor 3.9 contains a buffer overflow vulnerability that allows attacker...</sub><br><sub>Published: `2026-01-30`</sub> | [**CutiesAI**](https://www.google.com/search?q=CutiesAI%20data%20breach&tbm=nws) &nbsp; <sub>`cuties.ai`</sub><br><sub>**144,250** accounts compromised</sub><br><sub>Data: `avatars` `display names` `email addresses` &nbsp;·&nbsp; Added: `2026-03-31`</sub> |
| [**`CVE-2020-37042`**](https://nvd.nist.gov/vuln/detail/CVE-2020-37042) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.4**<br><sub>Frigate Professional 3.36.0.9 contains a local buffer overflow vulnerability in the 'Find Com...</sub><br><sub>Published: `2026-01-30`</sub> | [**BreachForumsV5**](https://www.google.com/search?q=BreachForumsV5%20data%20breach&tbm=nws) &nbsp; <sub>`breachforums.bf`</sub><br><sub>**339,778** accounts compromised</sub><br><sub>Data: `email addresses` `passwords` `usernames` &nbsp;·&nbsp; Added: `2026-03-27`</sub> |
| [**`CVE-2020-37041`**](https://nvd.nist.gov/vuln/detail/CVE-2020-37041) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>OpenCTI 3.3.1 is vulnerable to a directory traversal attack via the static/css endpoint. An u...</sub><br><sub>Published: `2026-01-30`</sub> | [**ScufGaming**](https://www.google.com/search?q=ScufGaming%20data%20breach&tbm=nws) &nbsp; <sub>`scufgaming.com`</sub><br><sub>**128,683** accounts compromised</sub><br><sub>Data: `display names` `email addresses` `ip addresses` &nbsp;·&nbsp; Added: `2026-03-26`</sub> |
<!-- SECURITY-END -->
---
