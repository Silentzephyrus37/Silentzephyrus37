...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-05-07 10:29 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-3812`**](https://nvd.nist.gov/vuln/detail/CVE-2026-3812) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.3**<br><sub>A vulnerability was determined in itsourcecode Payroll Management System 1.0. Affected is an ...</sub><br><sub>Published: `2026-03-09`</sub> | [**Woflow**](https://www.google.com/search?q=Woflow%20data%20breach&tbm=nws) &nbsp; <sub>`woflow.com`</sub><br><sub>**447,593** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-05-07`</sub> |
| [**`CVE-2026-3811`**](https://nvd.nist.gov/vuln/detail/CVE-2026-3811) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>A vulnerability was found in Tenda FH1202 1.2.0.14(408). This impacts the function fromP2pLis...</sub><br><sub>Published: `2026-03-09`</sub> | [**LegionProxy**](https://www.google.com/search?q=LegionProxy%20data%20breach&tbm=nws) &nbsp; <sub>`legionproxy.io`</sub><br><sub>**10,144** accounts compromised</sub><br><sub>Data: `email addresses` `names` `passwords` &nbsp;·&nbsp; Added: `2026-05-06`</sub> |
| [**`CVE-2026-24713`**](https://nvd.nist.gov/vuln/detail/CVE-2026-24713) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>Improper Input Validation vulnerability in Apache IoTDB.

This issue affects Apache IoTDB: fr...</sub><br><sub>Published: `2026-03-09`</sub> | [**Vimeo**](https://www.google.com/search?q=Vimeo%20data%20breach&tbm=nws) &nbsp; <sub>`vimeo.com`</sub><br><sub>**119,167** accounts compromised</sub><br><sub>Data: `email addresses` `names` &nbsp;·&nbsp; Added: `2026-05-05`</sub> |
<!-- SECURITY-END -->
---
