...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-04-26 09:07 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-22720`**](https://nvd.nist.gov/vuln/detail/CVE-2026-22720) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.0**<br><sub>VMware Aria Operations contains a stored cross-site scripting vulnerability. A malicious acto...</sub><br><sub>Published: `2026-02-25`</sub> | [**Carnival**](https://www.google.com/search?q=Carnival%20data%20breach&tbm=nws) &nbsp; <sub>`carnivalcorp.com`</sub><br><sub>**7,531,359** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-04-24`</sub> |
| [**`CVE-2026-22719`**](https://nvd.nist.gov/vuln/detail/CVE-2026-22719) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.1**<br><sub>VMware Aria Operations contains a command injection vulnerability. A malicious unauthenticate...</sub><br><sub>Published: `2026-02-25`</sub> | [**Amtrak**](https://www.google.com/search?q=Amtrak%20data%20breach&tbm=nws) &nbsp; <sub>`amtrak.com`</sub><br><sub>**2,147,679** accounts compromised</sub><br><sub>Data: `email addresses` `names` `physical addresses` &nbsp;·&nbsp; Added: `2026-04-17`</sub> |
| [**`CVE-2025-3525`**](https://nvd.nist.gov/vuln/detail/CVE-2025-3525) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.5**<br><sub>GitLab has remediated an issue in GitLab CE/EE affecting all versions from 9.0 before 18.7.5,...</sub><br><sub>Published: `2026-02-25`</sub> | [**McGrawHill**](https://www.google.com/search?q=McGrawHill%20data%20breach&tbm=nws) &nbsp; <sub>`mheducation.com`</sub><br><sub>**13,500,136** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-04-16`</sub> |
<!-- SECURITY-END -->
---
