...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-13 08:51 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2025-66177`**](https://nvd.nist.gov/vuln/detail/CVE-2025-66177) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>There is a Stack overflow Vulnerability in the device Search and Discovery feature of Hikvisi...</sub><br><sub>Published: `2026-01-13`</sub> | [**Provecho**](https://www.google.com/search?q=Provecho%20data%20breach&tbm=nws) &nbsp; <sub>`provecho.bio`</sub><br><sub>**712,904** accounts compromised</sub><br><sub>Data: `email addresses` `usernames` &nbsp;·&nbsp; Added: `2026-03-03`</sub> |
| [**`CVE-2025-66176`**](https://nvd.nist.gov/vuln/detail/CVE-2025-66176) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>There is a Stack overflow Vulnerability in the device Search and Discovery feature of Hikvisi...</sub><br><sub>Published: `2026-01-13`</sub> | [**Lovora**](https://www.google.com/search?q=Lovora%20data%20breach&tbm=nws) &nbsp; <sub>``</sub><br><sub>**495,556** accounts compromised</sub><br><sub>Data: `display names` `email addresses` `profile photos` &nbsp;·&nbsp; Added: `2026-03-02`</sub> |
| [**`CVE-2026-0514`**](https://nvd.nist.gov/vuln/detail/CVE-2026-0514) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.1**<br><sub>Due to a Cross-Site Scripting (XSS) vulnerability in SAP Business Connector, an unauthenticat...</sub><br><sub>Published: `2026-01-13`</sub> | [**Quitbro**](https://www.google.com/search?q=Quitbro%20data%20breach&tbm=nws) &nbsp; <sub>`quitbro.app`</sub><br><sub>**22,874** accounts compromised</sub><br><sub>Data: `email addresses` `partial dates of birth` `usernames` &nbsp;·&nbsp; Added: `2026-03-02`</sub> |
<!-- SECURITY-END -->
---
