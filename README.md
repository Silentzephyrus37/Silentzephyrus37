...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-05-03 09:25 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-20065`**](https://nvd.nist.gov/vuln/detail/CVE-2026-20065) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.8**<br><sub>Multiple Cisco products are affected by a vulnerability in the Snort 3 Detection Engine that ...</sub><br><sub>Published: `2026-03-04`</sub> | [**ZenBusiness**](https://www.google.com/search?q=ZenBusiness%20data%20breach&tbm=nws) &nbsp; <sub>`zenbusiness.com`</sub><br><sub>**5,118,184** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-05-02`</sub> |
| [**`CVE-2026-20063`**](https://nvd.nist.gov/vuln/detail/CVE-2026-20063) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.0**<br><sub>A vulnerability in the CLI of Cisco Secure FTD Software could allow an authenticated, local a...</sub><br><sub>Published: `2026-03-04`</sub> | [**Aman**](https://www.google.com/search?q=Aman%20data%20breach&tbm=nws) &nbsp; <sub>`aman.com`</sub><br><sub>**215,563** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-05-01`</sub> |
| [**`CVE-2026-20062`**](https://nvd.nist.gov/vuln/detail/CVE-2026-20062) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.2**<br><sub>A vulnerability in the CLI of Cisco Secure Firewall Adaptive Security Appliance (ASA) Softwar...</sub><br><sub>Published: `2026-03-04`</sub> | [**PitneyBowes**](https://www.google.com/search?q=PitneyBowes%20data%20breach&tbm=nws) &nbsp; <sub>`pitneybowes.com`</sub><br><sub>**8,243,989** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-04-27`</sub> |
<!-- SECURITY-END -->
---
