...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-26 09:05 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-24428`**](https://nvd.nist.gov/vuln/detail/CVE-2026-24428) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>Shenzhen Tenda W30E V2 firmware versions up to and including V16.01.0.19(5037) contain an aut...</sub><br><sub>Published: `2026-01-26`</sub> | [**ScufGaming**](https://www.google.com/search?q=ScufGaming%20data%20breach&tbm=nws) &nbsp; <sub>`scufgaming.com`</sub><br><sub>**128,683** accounts compromised</sub><br><sub>Data: `display names` `email addresses` `ip addresses` &nbsp;·&nbsp; Added: `2026-03-26`</sub> |
| [**`CVE-2026-21509`**](https://nvd.nist.gov/vuln/detail/CVE-2026-21509) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.8**<br><sub>Reliance on untrusted inputs in a security decision in Microsoft Office allows an unauthorize...</sub><br><sub>Published: `2026-01-26`</sub> | [**SoundRadix**](https://www.google.com/search?q=SoundRadix%20data%20breach&tbm=nws) &nbsp; <sub>`soundradix.com`</sub><br><sub>**292,993** accounts compromised</sub><br><sub>Data: `email addresses` `names` `passwords` &nbsp;·&nbsp; Added: `2026-03-26`</sub> |
| [**`CVE-2026-1446`**](https://nvd.nist.gov/vuln/detail/CVE-2026-1446) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.0**<br><sub>There is a Cross‑Site Scripting (XSS) issue in Esri ArcGIS Pro versions 3.6.0 and earlier. Ar...</sub><br><sub>Published: `2026-01-26`</sub> | [**RSBoards**](https://www.google.com/search?q=RSBoards%20data%20breach&tbm=nws) &nbsp; <sub>`rsboards.com`</sub><br><sub>**222,762** accounts compromised</sub><br><sub>Data: `email addresses` `ip addresses` `passwords` &nbsp;·&nbsp; Added: `2026-03-23`</sub> |
<!-- SECURITY-END -->
---
