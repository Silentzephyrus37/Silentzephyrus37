...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-18 08:58 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2025-52660`**](https://nvd.nist.gov/vuln/detail/CVE-2025-52660) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **2.7**<br><sub>HCL AION is affected by an Unrestricted File Upload vulnerability. This can allow malicious f...</sub><br><sub>Published: `2026-01-19`</sub> | [**Aura**](https://www.google.com/search?q=Aura%20data%20breach&tbm=nws) &nbsp; <sub>`aura.com`</sub><br><sub>**903,080** accounts compromised</sub><br><sub>Data: `customer service comments` `email addresses` `ip addresses` &nbsp;·&nbsp; Added: `2026-03-18`</sub> |
| [**`CVE-2025-52659`**](https://nvd.nist.gov/vuln/detail/CVE-2025-52659) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **2.8**<br><sub>HCL AION version 2 is affected by a Cacheable HTTP Response vulnerability. This may lead to u...</sub><br><sub>Published: `2026-01-19`</sub> | [**DivineSkins**](https://www.google.com/search?q=DivineSkins%20data%20breach&tbm=nws) &nbsp; <sub>`divineskins.gg`</sub><br><sub>**105,814** accounts compromised</sub><br><sub>Data: `email addresses` `purchases` `usernames` &nbsp;·&nbsp; Added: `2026-03-15`</sub> |
| [**`CVE-2026-23532`**](https://nvd.nist.gov/vuln/detail/CVE-2026-23532) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>FreeRDP is a free implementation of the Remote Desktop Protocol. Prior to version 3.21.0, a c...</sub><br><sub>Published: `2026-01-19`</sub> | [**Baydoner**](https://www.google.com/search?q=Baydoner%20data%20breach&tbm=nws) &nbsp; <sub>`baydoner.com`</sub><br><sub>**1,266,822** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-03-15`</sub> |
<!-- SECURITY-END -->
---
