...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-05-14 10:25 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-28521`**](https://nvd.nist.gov/vuln/detail/CVE-2026-28521) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.7**<br><sub>arduino-TuyaOpen before version 1.2.1 contains an out-of-bounds memory read vulnerability in ...</sub><br><sub>Published: `2026-03-16`</sub> | [**Abrigo**](https://www.google.com/search?q=Abrigo%20data%20breach&tbm=nws) &nbsp; <sub>`abrigo.com`</sub><br><sub>**711,099** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-05-14`</sub> |
| [**`CVE-2026-28520`**](https://nvd.nist.gov/vuln/detail/CVE-2026-28520) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.4**<br><sub>arduino-TuyaOpen before version 1.2.1 contains a single-byte buffer overflow vulnerability in...</sub><br><sub>Published: `2026-03-16`</sub> | [**CanadaLife**](https://www.google.com/search?q=CanadaLife%20data%20breach&tbm=nws) &nbsp; <sub>`canadalife.com`</sub><br><sub>**237,810** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-05-13`</sub> |
| [**`CVE-2026-28519`**](https://nvd.nist.gov/vuln/detail/CVE-2026-28519) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>arduino-TuyaOpen before version 1.2.1 contains a heap-based buffer overflow vulnerability in ...</sub><br><sub>Published: `2026-03-16`</sub> | [**CushmanWakefield**](https://www.google.com/search?q=CushmanWakefield%20data%20breach&tbm=nws) &nbsp; <sub>`cushmanwakefield.com`</sub><br><sub>**310,431** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-05-12`</sub> |
<!-- SECURITY-END -->
---
