...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-04-03 09:02 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-22780`**](https://nvd.nist.gov/vuln/detail/CVE-2026-22780) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.4**<br><sub>Rizin is a UNIX-like reverse engineering framework and command-line toolset. Prior to 0.8.2, ...</sub><br><sub>Published: `2026-02-02`</sub> | [**SUCCESS**](https://www.google.com/search?q=SUCCESS%20data%20breach&tbm=nws) &nbsp; <sub>`success.com`</sub><br><sub>**253,510** accounts compromised</sub><br><sub>Data: `device information` `email addresses` `ip addresses` &nbsp;·&nbsp; Added: `2026-04-01`</sub> |
| [**`CVE-2026-22778`**](https://nvd.nist.gov/vuln/detail/CVE-2026-22778) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>vLLM is an inference and serving engine for large language models (LLMs). From 0.8.3 to befor...</sub><br><sub>Published: `2026-02-02`</sub> | [**CutiesAI**](https://www.google.com/search?q=CutiesAI%20data%20breach&tbm=nws) &nbsp; <sub>`cuties.ai`</sub><br><sub>**144,250** accounts compromised</sub><br><sub>Data: `avatars` `display names` `email addresses` &nbsp;·&nbsp; Added: `2026-03-31`</sub> |
| [**`CVE-2026-1778`**](https://nvd.nist.gov/vuln/detail/CVE-2026-1778) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.9**<br><sub>Amazon SageMaker Python SDK before v3.1.1 or v2.256.0 disables TLS certificate verification f...</sub><br><sub>Published: `2026-02-02`</sub> | [**BreachForumsV5**](https://www.google.com/search?q=BreachForumsV5%20data%20breach&tbm=nws) &nbsp; <sub>`breachforums.bf`</sub><br><sub>**339,778** accounts compromised</sub><br><sub>Data: `email addresses` `passwords` `usernames` &nbsp;·&nbsp; Added: `2026-03-27`</sub> |
<!-- SECURITY-END -->
---
