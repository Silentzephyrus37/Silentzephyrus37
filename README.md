...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-28 08:49 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-24873`**](https://nvd.nist.gov/vuln/detail/CVE-2026-24873) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.8**<br><sub>Out-of-bounds Read vulnerability in Rinnegatamante lpp-vita.This issue affects lpp-vita: befo...</sub><br><sub>Published: `2026-01-27`</sub> | [**BreachForumsV5**](https://www.google.com/search?q=BreachForumsV5%20data%20breach&tbm=nws) &nbsp; <sub>`breachforums.bf`</sub><br><sub>**339,778** accounts compromised</sub><br><sub>Data: `email addresses` `passwords` `usernames` &nbsp;·&nbsp; Added: `2026-03-27`</sub> |
| [**`CVE-2026-24872`**](https://nvd.nist.gov/vuln/detail/CVE-2026-24872) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>improper pointer arithmetic

 vulnerability in ProjectSkyfire SkyFire_548.This issue affects ...</sub><br><sub>Published: `2026-01-27`</sub> | [**ScufGaming**](https://www.google.com/search?q=ScufGaming%20data%20breach&tbm=nws) &nbsp; <sub>`scufgaming.com`</sub><br><sub>**128,683** accounts compromised</sub><br><sub>Data: `display names` `email addresses` `ip addresses` &nbsp;·&nbsp; Added: `2026-03-26`</sub> |
| [**`CVE-2026-24870`**](https://nvd.nist.gov/vuln/detail/CVE-2026-24870) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **3.7**<br><sub>Exposure of Sensitive Information to an Unauthorized Actor vulnerability in ixray-team ixray-...</sub><br><sub>Published: `2026-01-27`</sub> | [**SoundRadix**](https://www.google.com/search?q=SoundRadix%20data%20breach&tbm=nws) &nbsp; <sub>`soundradix.com`</sub><br><sub>**292,993** accounts compromised</sub><br><sub>Data: `email addresses` `names` `passwords` &nbsp;·&nbsp; Added: `2026-03-26`</sub> |
<!-- SECURITY-END -->
---
