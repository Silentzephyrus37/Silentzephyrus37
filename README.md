...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-08 08:38 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2025-47337`**](https://nvd.nist.gov/vuln/detail/CVE-2025-47337) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.7**<br><sub>Memory corruption while accessing a synchronization object during concurrent operations.</sub><br><sub>Published: `2026-01-07`</sub> | [**Provecho**](https://www.google.com/search?q=Provecho%20data%20breach&tbm=nws) &nbsp; <sub>`provecho.bio`</sub><br><sub>**712,904** accounts compromised</sub><br><sub>Data: `email addresses` `usernames` &nbsp;·&nbsp; Added: `2026-03-03`</sub> |
| [**`CVE-2025-47336`**](https://nvd.nist.gov/vuln/detail/CVE-2025-47336) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.7**<br><sub>Memory corruption while performing sensor register read operations.</sub><br><sub>Published: `2026-01-07`</sub> | [**Lovora**](https://www.google.com/search?q=Lovora%20data%20breach&tbm=nws) &nbsp; <sub>``</sub><br><sub>**495,556** accounts compromised</sub><br><sub>Data: `display names` `email addresses` `profile photos` &nbsp;·&nbsp; Added: `2026-03-02`</sub> |
| [**`CVE-2025-47335`**](https://nvd.nist.gov/vuln/detail/CVE-2025-47335) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.7**<br><sub>Memory corruption while parsing clock configuration data for a specific hardware type.</sub><br><sub>Published: `2026-01-07`</sub> | [**Quitbro**](https://www.google.com/search?q=Quitbro%20data%20breach&tbm=nws) &nbsp; <sub>`quitbro.app`</sub><br><sub>**22,874** accounts compromised</sub><br><sub>Data: `email addresses` `partial dates of birth` `usernames` &nbsp;·&nbsp; Added: `2026-03-02`</sub> |
<!-- SECURITY-END -->
---
