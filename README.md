...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-05-17 09:52 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-4396`**](https://nvd.nist.gov/vuln/detail/CVE-2026-4396) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.1**<br><sub>Improper certificate validation in Devolutions Hub Reporting Service 
2025.3.1.1 and earlier ...</sub><br><sub>Published: `2026-03-18`</sub> | [**Abrigo**](https://www.google.com/search?q=Abrigo%20data%20breach&tbm=nws) &nbsp; <sub>`abrigo.com`</sub><br><sub>**711,099** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-05-14`</sub> |
| [**`CVE-2026-31971`**](https://nvd.nist.gov/vuln/detail/CVE-2026-31971) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.1**<br><sub>HTSlib is a library for reading and writing bioinformatics file formats. CRAM is a compressed...</sub><br><sub>Published: `2026-03-18`</sub> | [**CanadaLife**](https://www.google.com/search?q=CanadaLife%20data%20breach&tbm=nws) &nbsp; <sub>`canadalife.com`</sub><br><sub>**237,810** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-05-13`</sub> |
| [**`CVE-2026-31970`**](https://nvd.nist.gov/vuln/detail/CVE-2026-31970) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.1**<br><sub>HTSlib is a library for reading and writing bioinformatics file formats. GZI files are used t...</sub><br><sub>Published: `2026-03-18`</sub> | [**CushmanWakefield**](https://www.google.com/search?q=CushmanWakefield%20data%20breach&tbm=nws) &nbsp; <sub>`cushmanwakefield.com`</sub><br><sub>**310,431** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-05-12`</sub> |
<!-- SECURITY-END -->
---
