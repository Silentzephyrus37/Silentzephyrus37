...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-05-01 09:51 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-0655`**](https://nvd.nist.gov/vuln/detail/CVE-2026-0655) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.0**<br><sub>Improper Limitation of a Pathname to a Restricted Directory ('Path Traversal') vulnerability ...</sub><br><sub>Published: `2026-03-02`</sub> | [**Aman**](https://www.google.com/search?q=Aman%20data%20breach&tbm=nws) &nbsp; <sub>`aman.com`</sub><br><sub>**215,563** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-05-01`</sub> |
| [**`CVE-2026-0654`**](https://nvd.nist.gov/vuln/detail/CVE-2026-0654) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.0**<br><sub>Improper input handling in the administration web interface on TP-Link Deco BE25 v1.0 allows ...</sub><br><sub>Published: `2026-03-02`</sub> | [**PitneyBowes**](https://www.google.com/search?q=PitneyBowes%20data%20breach&tbm=nws) &nbsp; <sub>`pitneybowes.com`</sub><br><sub>**8,243,989** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-04-27`</sub> |
| [**`CVE-2026-28401`**](https://nvd.nist.gov/vuln/detail/CVE-2026-28401) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.4**<br><sub>NocoDB is software for building databases as spreadsheets. Prior to version 0.301.3, rich tex...</sub><br><sub>Published: `2026-03-02`</sub> | [**ADT**](https://www.google.com/search?q=ADT%20data%20breach&tbm=nws) &nbsp; <sub>`adt.com`</sub><br><sub>**5,488,888** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `names` &nbsp;·&nbsp; Added: `2026-04-27`</sub> |
<!-- SECURITY-END -->
---
