...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-29 08:51 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2022-40620`**](https://nvd.nist.gov/vuln/detail/CVE-2022-40620) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.7**<br><sub>FunJSQ, a third-party module integrated on some NETGEAR routers and Orbi WiFi Systems, does n...</sub><br><sub>Published: `2026-01-28`</sub> | [**BreachForumsV5**](https://www.google.com/search?q=BreachForumsV5%20data%20breach&tbm=nws) &nbsp; <sub>`breachforums.bf`</sub><br><sub>**339,778** accounts compromised</sub><br><sub>Data: `email addresses` `passwords` `usernames` &nbsp;·&nbsp; Added: `2026-03-27`</sub> |
| [**`CVE-2022-40619`**](https://nvd.nist.gov/vuln/detail/CVE-2022-40619) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.7**<br><sub>FunJSQ, a third-party module integrated on some NETGEAR routers and Orbi WiFi Systems, expose...</sub><br><sub>Published: `2026-01-28`</sub> | [**ScufGaming**](https://www.google.com/search?q=ScufGaming%20data%20breach&tbm=nws) &nbsp; <sub>`scufgaming.com`</sub><br><sub>**128,683** accounts compromised</sub><br><sub>Data: `display names` `email addresses` `ip addresses` &nbsp;·&nbsp; Added: `2026-03-26`</sub> |
| [**`CVE-2025-71000`**](https://nvd.nist.gov/vuln/detail/CVE-2025-71000) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>An issue in the flow.cuda.BoolTensor component of OneFlow v0.9.0 allows attackers to cause a ...</sub><br><sub>Published: `2026-01-28`</sub> | [**SoundRadix**](https://www.google.com/search?q=SoundRadix%20data%20breach&tbm=nws) &nbsp; <sub>`soundradix.com`</sub><br><sub>**292,993** accounts compromised</sub><br><sub>Data: `email addresses` `names` `passwords` &nbsp;·&nbsp; Added: `2026-03-26`</sub> |
<!-- SECURITY-END -->
---
