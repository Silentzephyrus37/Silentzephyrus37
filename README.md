...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-16 09:04 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2025-13844`**](https://nvd.nist.gov/vuln/detail/CVE-2025-13844) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.3**<br><sub>CWE-415: Double Free vulnerability exists that could cause heap memory corruption when the en...</sub><br><sub>Published: `2026-01-15`</sub> | [**DivineSkins**](https://www.google.com/search?q=DivineSkins%20data%20breach&tbm=nws) &nbsp; <sub>`divineskins.gg`</sub><br><sub>**105,814** accounts compromised</sub><br><sub>Data: `email addresses` `purchases` `usernames` &nbsp;·&nbsp; Added: `2026-03-15`</sub> |
| [**`CVE-2025-9014`**](https://nvd.nist.gov/vuln/detail/CVE-2025-9014) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>A Null Pointer Dereference vulnerability exists in the referer header check of the web portal...</sub><br><sub>Published: `2026-01-15`</sub> | [**Baydoner**](https://www.google.com/search?q=Baydoner%20data%20breach&tbm=nws) &nbsp; <sub>`baydoner.com`</sub><br><sub>**1,266,822** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-03-15`</sub> |
| [**`CVE-2025-70307`**](https://nvd.nist.gov/vuln/detail/CVE-2025-70307) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>A stack overflow in the dump_ttxt_sample function of GPAC v2.4.0 allows attackers to cause a ...</sub><br><sub>Published: `2026-01-15`</sub> | [**Provecho**](https://www.google.com/search?q=Provecho%20data%20breach&tbm=nws) &nbsp; <sub>`provecho.bio`</sub><br><sub>**712,904** accounts compromised</sub><br><sub>Data: `email addresses` `usernames` &nbsp;·&nbsp; Added: `2026-03-03`</sub> |
<!-- SECURITY-END -->
---
