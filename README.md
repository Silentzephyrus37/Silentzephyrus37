...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-03 08:52 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2025-34171`**](https://nvd.nist.gov/vuln/detail/CVE-2025-34171) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.3**<br><sub>CasaOS versions up to and including 0.4.15 expose multiple unauthenticated endpoints that all...</sub><br><sub>Published: `2026-01-02`</sub> | [**Provecho**](https://www.google.com/search?q=Provecho%20data%20breach&tbm=nws) &nbsp; <sub>`provecho.bio`</sub><br><sub>**712,904** accounts compromised</sub><br><sub>Data: `email addresses` `usernames` &nbsp;·&nbsp; Added: `2026-03-03`</sub> |
| [**`CVE-2025-15439`**](https://nvd.nist.gov/vuln/detail/CVE-2025-15439) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.3**<br><sub>A vulnerability was identified in Daptin 0.10.3. Affected by this vulnerability is the functi...</sub><br><sub>Published: `2026-01-02`</sub> | [**Lovora**](https://www.google.com/search?q=Lovora%20data%20breach&tbm=nws) &nbsp; <sub>``</sub><br><sub>**495,556** accounts compromised</sub><br><sub>Data: `display names` `email addresses` `profile photos` &nbsp;·&nbsp; Added: `2026-03-02`</sub> |
| [**`CVE-2025-9110`**](https://nvd.nist.gov/vuln/detail/CVE-2025-9110) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>An exposure of sensitive system information to an unauthorized control sphere vulnerability h...</sub><br><sub>Published: `2026-01-02`</sub> | [**Quitbro**](https://www.google.com/search?q=Quitbro%20data%20breach&tbm=nws) &nbsp; <sub>`quitbro.app`</sub><br><sub>**22,874** accounts compromised</sub><br><sub>Data: `email addresses` `partial dates of birth` `usernames` &nbsp;·&nbsp; Added: `2026-03-02`</sub> |
<!-- SECURITY-END -->
---
