...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-04-22 09:26 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-2966`**](https://nvd.nist.gov/vuln/detail/CVE-2026-2966) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **3.7**<br><sub>A weakness has been identified in Cesanta Mongoose up to 7.20. The impacted element is the fu...</sub><br><sub>Published: `2026-02-23`</sub> | [**Amtrak**](https://www.google.com/search?q=Amtrak%20data%20breach&tbm=nws) &nbsp; <sub>`amtrak.com`</sub><br><sub>**2,147,679** accounts compromised</sub><br><sub>Data: `email addresses` `names` `physical addresses` &nbsp;·&nbsp; Added: `2026-04-17`</sub> |
| [**`CVE-2026-2965`**](https://nvd.nist.gov/vuln/detail/CVE-2026-2965) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **2.4**<br><sub>A security flaw has been discovered in 07FLYCMS, 07FLY-CMS and 07FlyCRM up to 1.2.9. The affe...</sub><br><sub>Published: `2026-02-23`</sub> | [**McGrawHill**](https://www.google.com/search?q=McGrawHill%20data%20breach&tbm=nws) &nbsp; <sub>`mheducation.com`</sub><br><sub>**13,500,136** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-04-16`</sub> |
| [**`CVE-2026-2964`**](https://nvd.nist.gov/vuln/detail/CVE-2026-2964) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.0**<br><sub>A vulnerability was identified in higuma web-audio-recorder-js 0.1/0.1.1. Impacted is the fun...</sub><br><sub>Published: `2026-02-23`</sub> | [**Hallmark**](https://www.google.com/search?q=Hallmark%20data%20breach&tbm=nws) &nbsp; <sub>`hallmark.com`</sub><br><sub>**1,736,520** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-04-12`</sub> |
<!-- SECURITY-END -->
---
