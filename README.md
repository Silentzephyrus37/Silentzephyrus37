...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-03-17 08:59 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-23742`**](https://nvd.nist.gov/vuln/detail/CVE-2026-23742) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>Skipper is an HTTP router and reverse proxy for service composition. The default skipper conf...</sub><br><sub>Published: `2026-01-16`</sub> | [**DivineSkins**](https://www.google.com/search?q=DivineSkins%20data%20breach&tbm=nws) &nbsp; <sub>`divineskins.gg`</sub><br><sub>**105,814** accounts compromised</sub><br><sub>Data: `email addresses` `purchases` `usernames` &nbsp;·&nbsp; Added: `2026-03-15`</sub> |
| [**`CVE-2026-23731`**](https://nvd.nist.gov/vuln/detail/CVE-2026-23731) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.3**<br><sub>WeGIA is a web manager for charitable institutions. Prior to 3.6.2, The web application is vu...</sub><br><sub>Published: `2026-01-16`</sub> | [**Baydoner**](https://www.google.com/search?q=Baydoner%20data%20breach&tbm=nws) &nbsp; <sub>`baydoner.com`</sub><br><sub>**1,266,822** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-03-15`</sub> |
| [**`CVE-2026-23730`**](https://nvd.nist.gov/vuln/detail/CVE-2026-23730) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.1**<br><sub>WeGIA is a web manager for charitable institutions. Prior to 3.6.2, an Open Redirect vulnerab...</sub><br><sub>Published: `2026-01-16`</sub> | [**Provecho**](https://www.google.com/search?q=Provecho%20data%20breach&tbm=nws) &nbsp; <sub>`provecho.bio`</sub><br><sub>**712,904** accounts compromised</sub><br><sub>Data: `email addresses` `usernames` &nbsp;·&nbsp; Added: `2026-03-03`</sub> |
<!-- SECURITY-END -->
---
